    ...
    return (
        <footer className="border-t border-gray-200 py-4 dark:text-gray-600 dark:bg-white">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 px-6">
                ...
                <Link href="https://www.instagram.com/delima_design_build/" className="text-gray-600 hover:text-green-700">Instagram</Link>
                <Link href="https://wa.me/62817737972" className="text-gray-600 hover:text-green-700">Whatsapp</Link>
                </div>
            </div>
        </footer>
    )
